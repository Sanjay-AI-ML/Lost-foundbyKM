...
urlpatterns = [
    ...
    path('items/<int:pk>', views.item_detail_view),
    path('record/<int:pk>/', views.item_detail_view, name='record_detail'),
    path('record/<int:pk>', views.item_detail_view),
    path('records/<int:pk>/', views.item_detail_view, name='records_detail'),
    path('records/<int:pk>', views.item_detail_view),
